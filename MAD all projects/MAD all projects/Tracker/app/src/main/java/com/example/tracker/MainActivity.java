...
public class MainActivity extends BaseFragmentActivity {
    ...
    private void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            ...
            case R.id.nav_categories:
                loadFragment(Fragment.class, menuItem.getItemId(), menuItem.getTitle());
                break;
            case R.id.nav_settings:
                startActivity(new Intent(MainActivity.this, SettingsActivity.class));
                break;
            default:
                loadFragment(loadTodayFragment().class, menuItem.getItemId(), menuItem.getTitle());
        }
    }
    ...
    private void loadTodayFragment() {
        loadFragment(Fragment.class, R.id.nav_today,
